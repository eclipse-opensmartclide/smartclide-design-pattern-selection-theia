...
export class BehavioralPatterns{
    ...
    behavioralPatternsWizard(divCont: HTMLDivElement, messageService: MessageService, BackendService: BackendService){
			divCont.innerHTML = "";
										...
										buttonNext4.addEventListener('click', async (e: Event) =>{
											...
											buttonCodeMP.addEventListener('click', async (e: Event) =>{
												...
												if (message == "Input is valid"){
													BehavioralPatterns.functions.checkMessage(await BackendService.codeGeneration(window.location.href, BehavioralPatterns.values["Mediator"].values, "Mediator"), messageService);
												}else{
												...
												buttonNext8b.addEventListener('click', async (e: Event) =>{	
												  ...
												  buttonNext9.addEventListener('click', async (e: Event) =>{
													...
													buttonCodeCP.addEventListener('click', async (e: Event) =>{
														...
														let message = BehavioralPatterns.functions.checkInputsOnSubmit(1);
														if (message == "Input is valid"){
															BehavioralPatterns.functions.checkMessage(await BackendService.codeGeneration(window.location.href, BehavioralPatterns.values["Command"].values, "Command"), messageService);
														}else{
															messageService.info(message);
														}
													});
					...
					buttonNext.addEventListener('click', async(e: Event) =>{
						...
						buttonNext1.addEventListener('click', async (e: Event) =>{
							...
							buttonNext2.addEventListener('click', async (e: Event) =>{
								...
								let message = BehavioralPatterns.functions.checkInputsOnSubmit(1);
								if (message == "Input is valid"){
									BehavioralPatterns.functions.checkMessage(await BackendService.codeGeneration(window.location.href, BehavioralPatterns.values["ChainOfResponsibility"].values, "ChainOfResponsibility"), messageService);
								}else{
									messageService.info(message);
								}			
								});
									  ...
									  buttonNext3.addEventListener('click', async (e: Event) =>{
										...
										buttonNext4.addEventListener('click', async (e: Event) =>{
											...
											buttonCodeVP.addEventListener('click', async (e: Event) =>{
												...
												let message = BehavioralPatterns.functions.checkInputsOnSubmit(1);
												if (message == "Input is valid"){
													BehavioralPatterns.functions.checkMessage(await BackendService.codeGeneration(window.location.href, BehavioralPatterns.values["Visitor"].values, "Visitor"), messageService);
												}else{
													messageService.info(message);
												}
											});
										...
										buttonNext2.addEventListener('click', async (e: Event) =>{
											...
											buttonNext3.addEventListener('click', async (e: Event) =>{
												...
												buttonCodeTMP.addEventListener('click', async (e: Event) =>{
													...
													let message = BehavioralPatterns.functions.checkInputsOnSubmit(1);
													if (message == "Input is valid"){
														BehavioralPatterns.functions.checkMessage(await BackendService.codeGeneration(window.location.href, BehavioralPatterns.values["TemplateMethod"].values, "TemplateMethod"), messageService);
													}else{
														messageService.info(message);
													}
												});
											...
											buttonNext3.addEventListener('click', async (e: Event) =>{
												...
												buttonNext4.addEventListener('click', async (e: Event) =>{
													...
													buttonCodeSP.addEventListener('click', async (e: Event) =>{
														...
														let message = BehavioralPatterns.functions.checkInputsOnSubmit(1);
														if (message == "Input is valid"){
															BehavioralPatterns.functions.checkMessage(await BackendService.codeGeneration(window.location.href, BehavioralPatterns.values["Strategy"].values, "Strategy"), messageService);
														}else{
															messageService.info(message);
														}
													});
										  ...
										  buttonNext6b.addEventListener('click', async (e: Event) =>{
											...
											buttonNext7.addEventListener('click', async (e: Event) =>{
												...
												buttonCodeMP.addEventListener('click', async (e: Event) =>{
													...
													let message = BehavioralPatterns.functions.checkInputsOnSubmit(1);
													if (message == "Input is valid"){
														BehavioralPatterns.functions.checkMessage(await BackendService.codeGeneration(window.location.href, BehavioralPatterns.values["Memento"].values, "Memento"), messageService);
													}else{
														messageService.info(message);
													}
												});
												...
												buttonNext7.addEventListener('click', async (e: Event) =>{
													...
													buttonNext8.addEventListener('click', async (e: Event) =>{
														...
														buttonCodeOP.addEventListener('click', async (e: Event) =>{
															...
															let message = BehavioralPatterns.functions.checkInputsOnSubmit(1);
															if (message == "Input is valid"){
																BehavioralPatterns.functions.checkMessage(await BackendService.codeGeneration(window.location.href, BehavioralPatterns.values["Observer"].values, "Observer"), messageService);
															}else{
																messageService.info(message);
															}
														});
											...
											buttonNext3.addEventListener('click', async (e: Event) =>{
												...
												buttonNext4.addEventListener('click', async (e: Event) =>{
													...
													buttonCodeSP.addEventListener('click', async (e: Event) =>{
														...
														let message = BehavioralPatterns.functions.checkInputsOnSubmit(1);
														if (message == "Input is valid"){
															BehavioralPatterns.functions.checkMessage(await BackendService.codeGeneration(window.location.href, BehavioralPatterns.values["State"].values, "State"), messageService);
														}else{
															messageService.info(message);
														}
													});
