				...
				if (extensionWidget.state.statePatternSelection=="Adapter"){
					...
					if (extensionWidget.res.includes(adapteeName)){
						...
						if (methodNames.includes(methodName)){
							extensionWidget.functions.updateJsonObject();
					...
					extensionWidget.functions.updateJsonObject();
					extensionWidget.functions.insertInputsAbstractFactory();
					extensionWidget.functions.checkMessage(await this.helloBackendService.codeGeneration(window.location.href, extensionWidget.data[extensionWidget.state.statePatternSelection].values, extensionWidget.state.statePatternSelection));
				}else if(extensionWidget.state.statePatternSelection == "FactoryMethod"){
					extensionWidget.functions.updateJsonObject();
					extensionWidget.functions.insertInputsFactoryMethod();
					...
					extensionWidget.functions.updateJsonObject();
					extensionWidget.functions.insertInputsBuilder();
					extensionWidget.functions.checkMessage(await this.helloBackendService.codeGeneration(window.location.href, extensionWidget.data[extensionWidget.state.statePatternSelection].values, extensionWidget.state.statePatternSelection));
				}else{
					extensionWidget.functions.updateJsonObject();
					extensionWidget.functions.checkMessage(await this.helloBackendService.codeGeneration(window.location.href, extensionWidget.data[extensionWidget.state.statePatternSelection].values, extensionWidget.state.statePatternSelection));
