...
export class extensionWidget extends ReactWidget {
		...
		return <div id='widget-container'>
			...
			<div id='issues'>
				...
				<div id="result">
					...
					<div id="elements">
						<button id="btn-finalize" type="button" title='Get the code according to the pattern' onClick={_a => this.getCode((document.getElementById('show_pattern_table') as HTMLTableElement))}> Get Code </button>
					</div>
				</div>
			</div>
	...
	async getCode(table: HTMLTableElement): Promise<void> {
