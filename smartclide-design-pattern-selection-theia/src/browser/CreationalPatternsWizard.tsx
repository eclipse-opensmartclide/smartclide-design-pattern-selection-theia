												...
												buttonNext5.addEventListener('click', async (e: Event) =>{
													...
													buttonCodeAFP.addEventListener('click', async (e: Event) =>{
														...
														if (message == "Input is valid"){
															CreationalPatterns.functions.checkMessage(await this.helloBackendService.codeGeneration(window.location.href, extensionWidget.data["AbstractFactory"].values, "AbstractFactory"));
														}else{
												...
												buttonNext6.addEventListener('click', async (e: Event) =>{
													...
													buttonNext7.addEventListener('click', async (e: Event) =>{
														...
														buttonCodeBP.addEventListener('click', async (e: Event) =>{
															...
															let message = CreationalPatterns.functions.checkInputs(textfieldArray);
															if (message == "Input is valid"){
																CreationalPatterns.functions.checkMessage(await this.helloBackendService.codeGeneration(window.location.href, extensionWidget.data["Builder"].values, "Builder"));
															}else{
																this.messageService.info(message);
															}
														});
											...
											radio72.addEventListener('click', async (e: Event) =>{
												...
												buttonNext8.addEventListener('click', async (e: Event) =>{
													...
													buttonCodeFMP.addEventListener('click', async (e: Event) =>{
															...
															let message = CreationalPatterns.functions.checkInputs(textfieldArray);																
															if (message == "Input is valid"){
																CreationalPatterns.functions.checkMessage(await this.helloBackendService.codeGeneration(window.location.href, extensionWidget.data["FactoryMethod"].values, "FactoryMethod"));
															}else{
																this.messageService.info(message);
															}
													});
						...
						buttonNext9.addEventListener('click', async (e: Event) =>{
							...
							buttonCodeSP.addEventListener('click', async (e: Event) =>{
								...
								if (singlName==""){
									...
									CreationalPatterns.functions.checkMessage(await this.helloBackendService.codeGeneration(window.location.href, extensionWidget.data["Singleton"].values, "Singleton"));
								}
							});
						});
						divCont3.appendChild(divCont4);
								...
								buttonNext11.addEventListener('click', async (e: Event) =>{
									...
									buttonNext12.addEventListener('click', async (e: Event) =>{
										...
										buttonCodePP.addEventListener('click', async (e: Event) =>{
											...
											let message = CreationalPatterns.functions.checkInputs(textfieldArray);
											if (message == "Input is valid"){											
												CreationalPatterns.functions.checkMessage(await this.helloBackendService.codeGeneration(window.location.href, extensionWidget.data["Prototype"].values, "Prototype"));
											}else{
												this.messageService.info(message);
											}
										});
