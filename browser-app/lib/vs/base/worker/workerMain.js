...
(function() {
var __m = ["exports","require","vs/base/common/platform","vs/editor/common/core/position","vs/base/common/errors","vs/editor/common/core/range","vs/base/common/strings","vs/base/common/functional","vs/base/common/lifecycle","vs/base/common/diff/diff","vs/base/common/types","vs/base/common/uint","vs/base/common/uri","vs/base/common/stopwatch","vs/base/common/event","vs/base/common/cancellation","vs/base/common/arrays","vs/base/common/hash","vs/base/common/linkedList","vs/base/common/diff/diffChange","vs/base/common/process","vs/base/common/path","vs/editor/common/model/mirrorTextModel","vs/editor/common/core/characterClassifier","vs/base/common/iterator","vs/base/common/keyCodes","vs/editor/common/core/selection","vs/editor/common/core/token","vs/editor/common/diff/diffComputer","vs/editor/common/model/wordHelper","vs/editor/common/modes/linkComputer","vs/editor/common/modes/supports/inplaceReplaceSupport","vs/editor/common/standalone/standaloneEnums","vs/editor/common/standalone/standaloneBase","vs/editor/common/viewModel/prefixSumComputer","vs/base/common/worker/simpleWorker","vs/editor/common/services/editorSimpleWorker"];
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[19/*vs/base/common/diff/diffChange*/], __M([1/*require*/,0/*exports*/]), function (require, exports) {
    "use strict";
...
define(__m[4/*vs/base/common/errors*/], __M([1/*require*/,0/*exports*/]), function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    var CancellationError = /** @class */ (function (_super) {
        ...
        function CancellationError() {
            var _this = _super.call(this, canceledName) || this;
    ...
    var NotSupportedError = /** @class */ (function (_super) {
        ...
        function NotSupportedError(message) {
            var _this = _super.call(this, 'NotSupported') || this;
            if (message) {
                _this.message = message;
            }
            return _this;
...
define(__m[16/*vs/base/common/arrays*/], __M([1/*require*/,0/*exports*/,4/*vs/base/common/errors*/]), function (require, exports, errors_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    function groupBy(data, compare) {
        ...
        try {
            for (var _b = __values(mergeSort(data.slice(0), compare)), _c = _b.next(); !_c.done; _c = _b.next()) {
    ...
    function sortedDiff(before, after, compare) {
        ...
        function pushSplice(start, deleteCount, toInsert) {
            ...
            if (latest && latest.start + latest.deleteCount === start) {
                ...
                (_a = latest.toInsert).push.apply(_a, __spreadArray([], __read(toInsert)));
            }
            else {
    ...
    function delta(before, after, compare) {
        ...
        try {
            for (var splices_1 = __values(splices), splices_1_1 = splices_1.next(); !splices_1_1.done; splices_1_1 = splices_1.next()) {
                ...
                removed.push.apply(removed, __spreadArray([], __read(before.slice(splice.start, splice.start + splice.deleteCount))));
                added.push.apply(added, __spreadArray([], __read(splice.toInsert)));
            }
        }
    ...
    function flatten(arr) {
        var _a;
        return (_a = []).concat.apply(_a, __spreadArray([], __read(arr)));
    }
    ...
    function insert(array, element) {
        array.push(element);
        return function () { return remove(array, element); };
    }
...
define(__m[24/*vs/base/common/iterator*/], __M([1/*require*/,0/*exports*/]), function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[25/*vs/base/common/keyCodes*/], __M([1/*require*/,0/*exports*/,4/*vs/base/common/errors*/]), function (require, exports, errors_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define(__m[8/*vs/base/common/lifecycle*/], __M([1/*require*/,0/*exports*/,7/*vs/base/common/functional*/,24/*vs/base/common/iterator*/]), function (require, exports, functional_1, iterator_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define(__m[2/*vs/base/common/platform*/], __M([1/*require*/,0/*exports*/]), function (require, exports) {
    ...
    var _a;
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.isLittleEndian = exports.OS = exports.setImmediate = exports.globals = exports.translationsConfigFile = exports.locale = exports.Language = exports.language = exports.userAgent = exports.platform = exports.isIOS = exports.isWeb = exports.isNative = exports.isLinuxSnap = exports.isLinux = exports.isMacintosh = exports.isWindows = exports.PlatformToString = exports.isPreferringBrowserCodeLoad = exports.browserCodeLoadingCacheStrategy = exports.isElectronSandboxed = void 0;
    ...
    exports.browserCodeLoadingCacheStrategy = (function () {
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[20/*vs/base/common/process*/], __M([1/*require*/,0/*exports*/,2/*vs/base/common/platform*/]), function (require, exports, platform_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    // Native sandbox environment
        ...
        safeProcess = {
            ...
            // Unsupported
            cwd: function () { return platform_1.globals.vscode.process.env['VSCODE_CWD'] || platform_1.globals.vscode.process.execPath.substr(0, platform_1.globals.vscode.process.execPath.lastIndexOf(platform_1.globals.vscode.process.platform === 'win32' ? '\\' : '/')); }
        };
    }
    // Web environment
    else {
...
define(__m[21/*vs/base/common/path*/], __M([1/*require*/,0/*exports*/,20/*vs/base/common/process*/]), function (require, exports, process) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[13/*vs/base/common/stopwatch*/], __M([1/*require*/,0/*exports*/,2/*vs/base/common/platform*/]), function (require, exports, platform_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define(__m[14/*vs/base/common/event*/], __M([1/*require*/,0/*exports*/,4/*vs/base/common/errors*/,7/*vs/base/common/functional*/,8/*vs/base/common/lifecycle*/,18/*vs/base/common/linkedList*/,13/*vs/base/common/stopwatch*/]), function (require, exports, errors_1, functional_1, lifecycle_1, linkedList_1, stopwatch_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    (function (Event) {
        ...
        function any() {
            ...
            return function (listener, thisArgs, disposables) {
                if (thisArgs === void 0) { thisArgs = null; }
                return lifecycle_1.combinedDisposable.apply(void 0, __spreadArray([], __read(events.map(function (event) { return event(function (e) { return listener.call(thisArgs, e); }, null, disposables); }))));
            };
        }
        Event.any = any;
        /**
        ...
        function fromNodeEventEmitter(emitter, eventName, map) {
            ...
            var fn = function () {
                ...
                return result.fire(map.apply(void 0, __spreadArray([], __read(args))));
            };
        ...
        function toPromise(event) {
            return new Promise(function (resolve) { return once(event)(resolve); });
        }
        Event.toPromise = toPromise;
    })(Event = exports.Event || (exports.Event = {}));
    var EventProfiling = /** @class */ (function () {
        ...
        EventProfiling.prototype.start = function (listenerCount) {
            this._stopWatch = new stopwatch_1.StopWatch(true);
            this._listenerCount = listenerCount;
        };
        EventProfiling.prototype.stop = function () {
            if (this._stopWatch) {
    ...
    var LeakageMonitor = /** @class */ (function () {
        ...
        LeakageMonitor.prototype.check = function (listenerCount) {
            ...
            if (this._warnCountdown <= 0) {
                ...
                var topCount = 0;
                try {
                    for (var _b = __values(this._stacks), _c = _b.next(); !_c.done; _c = _b.next()) {
                        var _d = __read(_c.value, 2), stack_1 = _d[0], count_1 = _d[1];
                        if (!topStack || topCount < count_1) {
                            topStack = stack_1;
                            topCount = count_1;
                        }
                    }
    ...
    var Emitter = /** @class */ (function () {
            ...
            get: function () {
                ...
                if (!this._event) {
                    this._event = function (listener, thisArgs, disposables) {
                        ...
                        var removeMonitor = (_a = _this._leakageMon) === null || _a === void 0 ? void 0 : _a.check(_this._listeners.size);
                        var result;
                        result = {
                            dispose: function () {
                                if (removeMonitor) {
        ...
        Emitter.prototype.fire = function (event) {
            ...
            if (this._listeners) {
                ...
                try {
                    for (var _d = __values(this._listeners), _e = _d.next(); !_e.done; _e = _d.next()) {
                ...
                while (this._deliveryQueue.size > 0) {
                    var _f = __read(this._deliveryQueue.shift(), 2), listener = _f[0], event_1 = _f[1];
                    try {
    ...
    var PauseableEmitter = /** @class */ (function (_super) {
        ...
        function PauseableEmitter(options) {
            ...
            _this._mergeFn = options === null || options === void 0 ? void 0 : options.merge;
            return _this;
        }
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[15/*vs/base/common/cancellation*/], __M([1/*require*/,0/*exports*/,14/*vs/base/common/event*/]), function (require, exports, event_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[17/*vs/base/common/hash*/], __M([1/*require*/,0/*exports*/,6/*vs/base/common/strings*/]), function (require, exports, strings) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    function toHexString(bufferOrValue, bitsize) {
...
define(__m[9/*vs/base/common/diff/diff*/], __M([1/*require*/,0/*exports*/,19/*vs/base/common/diff/diffChange*/,17/*vs/base/common/hash*/]), function (require, exports, diffChange_1, hash_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define(__m[10/*vs/base/common/types*/], __M([1/*require*/,0/*exports*/]), function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[11/*vs/base/common/uint*/], __M([1/*require*/,0/*exports*/]), function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define(__m[12/*vs/base/common/uri*/], __M([1/*require*/,0/*exports*/,2/*vs/base/common/platform*/,21/*vs/base/common/path*/]), function (require, exports, platform_1, paths) {
    "use strict";
    var _a;
    Object.defineProperty(exports, "__esModule", { value: true });
...
define(__m[35/*vs/base/common/worker/simpleWorker*/], __M([1/*require*/,0/*exports*/,4/*vs/base/common/errors*/,8/*vs/base/common/lifecycle*/,2/*vs/base/common/platform*/,10/*vs/base/common/types*/]), function (require, exports, errors_1, lifecycle_1, platform_1, types) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[23/*vs/editor/common/core/characterClassifier*/], __M([1/*require*/,0/*exports*/,11/*vs/base/common/uint*/]), function (require, exports, uint_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define(__m[26/*vs/editor/common/core/selection*/], __M([1/*require*/,0/*exports*/,3/*vs/editor/common/core/position*/,5/*vs/editor/common/core/range*/]), function (require, exports, position_1, range_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[27/*vs/editor/common/core/token*/], __M([1/*require*/,0/*exports*/]), function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[28/*vs/editor/common/diff/diffComputer*/], __M([1/*require*/,0/*exports*/,9/*vs/base/common/diff/diff*/,6/*vs/base/common/strings*/]), function (require, exports, diff_1, strings) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define(__m[29/*vs/editor/common/model/wordHelper*/], __M([1/*require*/,0/*exports*/]), function (require, exports) {
    ...
    function createWordRegExp(allowInWords) {
        ...
        var source = '(-?\\d*\\.\\d\\w*)|([^';
        try {
            for (var USUAL_WORD_SEPARATORS_1 = __values(exports.USUAL_WORD_SEPARATORS), USUAL_WORD_SEPARATORS_1_1 = USUAL_WORD_SEPARATORS_1.next(); !USUAL_WORD_SEPARATORS_1_1.done; USUAL_WORD_SEPARATORS_1_1 = USUAL_WORD_SEPARATORS_1.next()) {
...
define(__m[30/*vs/editor/common/modes/linkComputer*/], __M([1/*require*/,0/*exports*/,23/*vs/editor/common/core/characterClassifier*/]), function (require, exports, characterClassifier_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[31/*vs/editor/common/modes/supports/inplaceReplaceSupport*/], __M([1/*require*/,0/*exports*/]), function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[32/*vs/editor/common/standalone/standaloneEnums*/], __M([1/*require*/,0/*exports*/]), function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[33/*vs/editor/common/standalone/standaloneBase*/], __M([1/*require*/,0/*exports*/,15/*vs/base/common/cancellation*/,14/*vs/base/common/event*/,25/*vs/base/common/keyCodes*/,12/*vs/base/common/uri*/,3/*vs/editor/common/core/position*/,5/*vs/editor/common/core/range*/,26/*vs/editor/common/core/selection*/,27/*vs/editor/common/core/token*/,32/*vs/editor/common/standalone/standaloneEnums*/]), function (require, exports, cancellation_1, event_1, keyCodes_1, uri_1, position_1, range_1, selection_1, token_1, standaloneEnums) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[34/*vs/editor/common/viewModel/prefixSumComputer*/], __M([1/*require*/,0/*exports*/,11/*vs/base/common/uint*/]), function (require, exports, uint_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define(__m[22/*vs/editor/common/model/mirrorTextModel*/], __M([1/*require*/,0/*exports*/,6/*vs/base/common/strings*/,3/*vs/editor/common/core/position*/,34/*vs/editor/common/viewModel/prefixSumComputer*/]), function (require, exports, strings_1, position_1, prefixSumComputer_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    var MirrorTextModel = /** @class */ (function () {
        ...
        MirrorTextModel.prototype._acceptInsertText = function (position, insertText) {
            ...
            var insertLines = strings_1.splitLines(insertText);
...
define(__m[36/*vs/editor/common/services/editorSimpleWorker*/], __M([1/*require*/,0/*exports*/,16/*vs/base/common/arrays*/,9/*vs/base/common/diff/diff*/,2/*vs/base/common/platform*/,12/*vs/base/common/uri*/,3/*vs/editor/common/core/position*/,5/*vs/editor/common/core/range*/,28/*vs/editor/common/diff/diffComputer*/,22/*vs/editor/common/model/mirrorTextModel*/,29/*vs/editor/common/model/wordHelper*/,30/*vs/editor/common/modes/linkComputer*/,31/*vs/editor/common/modes/supports/inplaceReplaceSupport*/,33/*vs/editor/common/standalone/standaloneBase*/,10/*vs/base/common/types*/,13/*vs/base/common/stopwatch*/]), function (require, exports, arrays_1, diff_1, platform_1, uri_1, position_1, range_1, diffComputer_1, mirrorTextModel_1, wordHelper_1, linkComputer_1, inplaceReplaceSupport_1, standaloneBase_1, types, stopwatch_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
(function () {
    ...
    var trustedTypesPolicy = (typeof ((_a = self.trustedTypes) === null || _a === void 0 ? void 0 : _a.createPolicy) === 'function'
        ? (_b = self.trustedTypes) === null || _b === void 0 ? void 0 : _b.createPolicy('amdLoader', { createScriptURL: function (value) { return value; } })
        : undefined);
    if (typeof self.define !== 'function' || !self.define.amd) {
        var loaderSrc = monacoBaseUrl + 'vs/loader.js';
        if (trustedTypesPolicy) {
